...
constexpr std::uint32_t kIngestParserVerMirror    = 121;  // MUST equal ingest.cpp's kParserVer   (gated)
                                                          // 121 = 2026-09-21 (Nix import round): dependencyCapable(Nix)
                                                          //    flips TRUE and nixPrepare emits file dependencies. 120 was
                                                          //    the grammar itself. See ingest_cache.h's kParserVer note.
                                                          // 120 = 2026-09-21 (Nix): a twenty-sixth grammar and its
                                                          //    definition/call extraction. See ingest_cache.h's kParserVer note.
