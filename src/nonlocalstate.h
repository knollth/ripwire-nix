...
// chain. Markdown, JSON, TOML and YAML are deliberately absent: they hold no functions, so naming them would
...
inline constexpr std::array<UnanalyzedLang, 17> kUnanalyzedLangs = { {
    ...
    { Lang::GDScript, "gdscript" }, { Lang::Nix, "nix" } } };
